...
import CProductRating from "../CProductRating/index";
const MAX_STAR_WIDTH = 105;
const MAX_CHAR = 120;
const MAX_RATING = 5.0;
const CNewProductDetail = ({ id }) => {
  ...
  return (
    <div className="product-detail-wrapper">
      <div className="detail-display-wrapper clearfix responsive-mid client-default-container">
        <CCard className="detail-gallery-container">
          <CImageSelector
            imgs={images}
        ...
        <CCard className="detail-display-info-container">
        ...
        <CCard className="product-rating-container">
...
export default CNewProductDetail;
